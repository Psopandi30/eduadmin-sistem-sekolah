...
const DashboardOrangTua: React.FC<DashboardOrangTuaProps> = ({ user, onLogout, schoolName = "SD IT EduAdmin" }) => {
    ...
    return (
        ...
        <div className="h-screen overflow-hidden bg-[#E0F2FE] font-sans flex flex-col relative">
            ...
            <div className={`flex-1 relative z-10 w-full max-w-7xl mx-auto scrollbar-hide transition-all duration-500 ${activeView === 'home' ? 'p-3 sm:p-4 md:p-8 overflow-y-auto pb-24 sm:pb-20' : 'p-0 overflow-hidden'}`}>
                {activeView === 'home' ? (

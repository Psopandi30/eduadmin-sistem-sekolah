...
const ProfilAkun: React.FC<ProfilAkunProps> = ({ user, onLogout, onBack }) => {
    ...
    return (
        <div className="bg-white/50 backdrop-blur-sm rounded-[2rem] border border-white/20 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-300 h-full flex flex-col overflow-hidden">
            {/* Header - Fixed at Top */}
            <div className="flex justify-between items-center p-5 border-b border-white/10 shrink-0 bg-white/40 backdrop-blur-md sticky top-0 z-10">

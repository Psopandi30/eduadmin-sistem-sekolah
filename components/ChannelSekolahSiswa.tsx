...
import { Play, Tv, Users, Calendar, Clock, ChevronRight, Share2, Heart, MessageCircle, MoreHorizontal, Video, Radio, Info } from 'lucide-react';
            ...
            const loadChannelData = async () => {
                ...
                try {
                    ...
                    if (bRes?.value) {
                        ...
                        setBroadcasts(Array.isArray(parsed) ? parsed : broadcastsDataGlobal); // Fallback to global if parsed is not array
                    } else {
                        setBroadcasts(broadcastsDataGlobal); // Fallback to global if no data
                    }
                    ...
                    if (sRes?.value) {
                        ...
                        setSettings(multimediaSettingsGlobal); // Fallback to global if no data
                    }
                } catch (err) {

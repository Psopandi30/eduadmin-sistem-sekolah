            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              ...
              <div className="p-8 space-y-5 overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                  ...
                  <div className="space-y-1"><label className="text-sm font-bold text-slate-600">Password</label><input type={stafModalMode === 'view' ? 'password' : 'text'} disabled={stafModalMode === 'view'} className="w-full px-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none disabled:bg-slate-100 font-mono" value={stafForm.password} onChange={e => setStafForm({ ...stafForm, password: e.target.value })} /></div>
                </div>
              </div>
              <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">

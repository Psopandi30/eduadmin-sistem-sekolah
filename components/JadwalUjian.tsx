...
const JadwalUjian: React.FC<JadwalUjianProps> = ({ onBack, user }) => {
    ...
    return (
        <div className="bg-white/90 backdrop-blur-xl rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl shadow-blue-900/10 border border-white overflow-hidden animate-in slide-in-from-right duration-500 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide p-5 sm:p-8 flex flex-col gap-5 sm:gap-6">
                {/* Day Tabs */}
                {/* Day Tabs */}
                ...
                <div className="flex-none">
                    <div className="flex items-center gap-4 bg-gradient-to-br from-[#004AAD] to-blue-700 rounded-2xl sm:rounded-[2rem] p-4 sm:p-6 shadow-lg shadow-blue-900/10 border border-white/20">
                        <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white shrink-0 border border-white/30">
                            <span className="text-lg font-black">!</span>
                        </div>
                        <div className="flex-1 min-w-0">
                            <p className="text-[9px] font-black text-blue-100 uppercase tracking-[0.2em] mb-1">Ketentuan Ujian</p>
                            <p className="text-xs sm:text-sm text-white font-bold leading-tight uppercase tracking-wide">
                ...
                {/* Schedule List / Empty State - Flex 1 to fill space */}
                <div className="flex-1 flex flex-col min-h-0">
                    {items.length > 0 ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center bg-slate-50/50 rounded-[2.5rem] border-2 border-dashed border-slate-200 p-8 text-center min-h-[200px]">

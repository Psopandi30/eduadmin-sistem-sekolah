...
export const quranSurahsGlobal = [
    ...
    { number: 23, name: "سُورَةُ المُؤْمِنُونَ", englishName: "Al-Mu'minoon", englishNameTranslation: "The Believers", numberOfAyahs: 118, revelationType: "Meccan" },
    ...
    { number: 77, name: "سُورَةُ المُارْسَلَاتِ", englishName: "Al-Mursalaat", englishNameTranslation: "The Emissaries", numberOfAyahs: 50, revelationType: "Meccan" },
    ...
    { number: 84, name: "سُورَةُ الانشِقَاقِ", englishName: "Al-Inshiqaaq", englishNameTranslation: "The Sundering", numberOfAyahs: 25, revelationType: "Meccan" },
    ...
    { number: 92, name: "سُورَةُ اللail", englishName: "Al-Lail", englishNameTranslation: "The Night", numberOfAyahs: 21, revelationType: "Meccan" },
